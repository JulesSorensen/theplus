...
// import { getPseudoFromToken } from "../utils/authUtils";
...
//     const [user, setUser] = useState(null); // Initialiser comme null
...
//             openGroupInvit(newGroup);
//         }
//     };

//     const openGroupInvit = (group) => {
//         navigation.navigate("GroupInvit", { groupName: group.name, groupId: group.id });
//     };
...
//                 groupId: 'someGroupId', // Ajoutez l'ID de groupe approprié
...
//         return (
//             <View style={isFromMe ? styles.messageContainerSent : styles.messageContainer}>
//                 <Image
//                     source={{
...
//     if (!user) return <></>; // Gardez ceci pour éviter les erreurs si user est null
